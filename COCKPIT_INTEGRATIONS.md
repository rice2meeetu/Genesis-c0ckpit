...
| SillyTavern 1.18.0 | `/mnt/C/Users/p4uln/SillyTavern`; `127.0.0.1:8000` | Starts through `genesis-sillytavern.service` only when its NTFS volume is writable; opens an already-running server without starting another. |
...
## SillyTavern feature readiness

- Solo RP: ready in existing SillyTavern.
- Group RP: ready in existing SillyTavern.
- Group Auto RP: ready through the existing bounded group controls.
- Image generation: existing SillyTavern-to-ComfyUI configuration is preserved;
...
- Installed llama.cpp flags, SillyTavern JavaScript syntax, ComfyUI environment,
