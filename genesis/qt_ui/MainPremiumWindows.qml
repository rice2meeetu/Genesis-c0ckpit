...
ApplicationWindow {
    ...
    minimumWidth: 1120
    minimumHeight: 720
    title: "GENESIS · Brother Standalone Image Wrapper"
    color: "#040404"
    ...
    onPageIndexChanged: lastWorkspacePage = pageIndex
    ...
    Shortcut { sequence: "Alt+3"; onActivated: appRoot.pageIndex = 3 }
    Shortcut { sequence: "Alt+4"; onActivated: appRoot.pageIndex = 11 }
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            text: runtimeStatus.routingSummary || (runtimeStatus.remote
                                ? (runtimeStatus.comfyOnline ? "●  REMOTE ONLINE" : "○  REMOTE OFFLINE")
                            ...
                            Panel {
                                ...
                                ColumnLayout {
                                    ...
                                    TextField {
                                        ...
                                        placeholderText: "Remote ComfyUI URL or pod ID"
                                        enabled: !genesisBridge.busy
                                        selectByMouse: true
                                    }
                                    RowLayout {
                        ...
                        GridLayout {
                            ...
                            Repeater {
                                model: [
                                    ...
                                    {title:"Stage 2 · Aisha 9B / Klein 9B", body:"Backend refinement using the preserved Stage 1 output; choose Aisha 9B v9.7 or FLUX.2 Klein 9B."},
                                    {title:"Stage 3 · selectable identity lock", body:"Verified ReActor Inswapper stays active. ReSwapper, HyperSwap and PuLID remain pending until backend verification passes."},
